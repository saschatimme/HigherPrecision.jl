...

{
    ...
    "category": "Function",
    "text": "sincos(x)\n\nCompute (sin(x), cos(x)). This is significant faster than computing the values separetly.\n\n\n\n"
},

{
    ...
    "category": "Function",
    "text": "sincosh(x)\n\nCompute (sinh(x), cosh(x)). This is significant faster than computing the values separetly.\n\n\n\n"
},
